...
class ClienteForm(FlaskForm):
    nombre = StringField(
        ...
        [
            ...
            Regexp(
                r"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$", message="Este campo solo acepta letras"
            ),
        ],
    )
    ...
    telefono = StringField(
        ...
        [
            ...
            Length(
                min=10, max=20, message="El telefono debe tener entre 10 y 20 digitos"
            ),
    ...
    categoria_comprador = SelectField(
