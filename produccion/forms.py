...
class FormOrdenProduccion(FlaskForm):
    producto_id = SelectField('Producto a Fabricar', coerce=int, validators=[DataRequired()])
    cantidad_requerida = IntegerField('Cantidad', validators=[DataRequired(), NumberRange(min=1)])
