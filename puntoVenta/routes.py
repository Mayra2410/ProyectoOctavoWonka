...
def finalizar_venta():
    ...
    if metodo_pago == 'TARJETA':
        ...
        tiene_tarjeta = TarjetaCliente.query.filter_by(cliente_id=cliente.id_cliente, activa=True).first()
    ...
    descuento = 0
    if cliente:
        es_vip = (cliente.tipo == 'MAYORISTA' or cliente.categoria_comprador == 'FRECUENTE')
    ...
    try:
        ...
        return redirect(url_for('gesVentas.ver_ticket', id=nueva_venta.id_venta, ahorro=descuento))
